...
function UpdateArticle() {
  ...
  const validate = () => {
    ...
    if (!formData.publicationDate || new Date(formData.publicationDate) > new Date()) {
      newErrors.publicationDate = 'Valid publication date is required.';
    }
  ...
  const handleSubmit = async (e) => {
    ...
    if (validate()) {
      try {
        ...
        const response = await axios.put(`http://localhost:5185/api/articles/${id}`, formDataToSend, {
          headers: {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="mb-4">
            ...
            <button
              ...
              className="bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 text-white px-6 py-2 rounded-md hover:bg-gradient-to-l"
            >
              Update Article
            </button>
