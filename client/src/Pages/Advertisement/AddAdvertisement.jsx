...
function AddAdvertisement() {
  ...
  const addAdvertisement = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:5185/api/advertisements', advertisementData, {
        headers: {
      ...
      const errorMessage =
        error.response?.data?.message || error.message || "Failed to add advertisement.";
      alert(errorMessage);
